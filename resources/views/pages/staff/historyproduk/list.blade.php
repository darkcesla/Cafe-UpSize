                        ...
                        <td>
                            <ul class="list-inline hstack gap-2 mb-0">
                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    ...
                                    <a href="{{ route('staff.historyproduk.show', $item->id) }}"
                                ...
                                data-bs-placement="top" title="" data-bs-original-title="Accept">
                                     <a href="javascript:;"
                                         onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','PUT','{{route('staff.historyproduk.accept',$item->id)}}');"
                                 ...
                                 <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                     ...
                                     <a href="javascript:;"
                                         onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','PUT','{{route('staff.historyproduk.reject',$item->id)}}');"
                                ...
                                data-bs-placement="top" title="" data-bs-original-title="Finish">
                                    <a href="javascript:;"
                                        onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','PUT','{{route('staff.historyproduk.finish',$item->id)}}');"
                                        class="text-success d-inline-block remove-item-btn">
                                ...
                                @endif
                                 ...
                                 <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                     ...
                                     <a href="javascript:;"
                                         onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','DELETE','{{route('staff.historyproduk.destroy',$item->id)}}');"
                                         class="text-danger d-inline-block remove-item-btn">
